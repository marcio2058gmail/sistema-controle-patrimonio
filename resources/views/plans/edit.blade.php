<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Editar: {{ $plan->nome }}</h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                <form method="POST" action="{{ route('plans.update', $plan) }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <x-text-input name="nome" type="text" class="w-full"
                                      value="{{ old('nome', $plan->nome) }}" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input name="limite_patrimonios" type="number" min="1" class="w-full"
                                      value="{{ old('limite_patrimonios', $plan->limite_patrimonios) }}" required />
                    ...
                    <div>
                        ...
                        <x-text-input name="preco" type="number" min="0" step="0.01" class="w-full"
                                      value="{{ old('preco', $plan->preco) }}" required />
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input type="checkbox" id="ativo" name="ativo" value="1"
                               ...
                               {{ old('ativo', $plan->ativo) ? 'checked' : '' }}>
                        <label for="ativo" class="text-sm font-medium text-gray-700 dark:text-gray-300">Plano ativo</label>
                    </div>
