    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                <form action="{{ route('managers.update', $manager) }}" method="POST" class="space-y-5">
                    @csrf @method('PUT')
                    ...
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text"
                            class="mt-1 block w-full" :value="old('name', $manager->name)" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" name="email" type="email"
                            class="mt-1 block w-full" :value="old('email', $manager->email)" required />
