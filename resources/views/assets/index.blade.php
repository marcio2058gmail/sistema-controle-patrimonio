                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-750">
                            ...
                            <td class="px-6 py-3 text-right space-x-3">
                                <a href="{{ route('assets.show', $asset) }}" class="text-blue-600 hover:underline text-xs">Ver</a>
                                @if(auth()->user()->isAdmin())
                                <a href="{{ route('assets.edit', $asset) }}" class="text-indigo-600 hover:underline text-xs">Editar</a>
