                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @php $ad = ['id'=>$asset->id,'code'=>$asset->codigo_patrimonio,'descricao'=>$asset->descricao,'modelo'=>$asset->modelo,'serie'=>$asset->numero_serie,'status'=>$asset->status,'created'=>$asset->created_at->format('d/m/Y'),'url_edit'=>auth()->user()->isAdmin()?route('assets.edit',$asset):'','url_destroy'=>auth()->user()->isAdmin()?route('assets.destroy',$asset):'','is_admin'=>auth()->user()->isAdmin()]; @endphp
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-750">
                                ...
                                <td class="px-6 py-3 text-right space-x-3">
                                    ...
                                    @if(auth()->user()->isAdmin())
                                    <a href="{{ route('assets.edit', $asset) }}" class="text-gray-600 hover:text-gray-800 dark:hover:text-gray-300 text-xs font-medium transition-colors">Editar</a>
