<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Editar Funcionário — {{ $employee->nome }}
        </h2>
    </x-slot>
                ...
                <form action="{{ route('employees.update', $employee) }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <x-text-input id="nome" name="nome" type="text"
                            class="mt-1 block w-full" :value="old('nome', $employee->nome)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" name="email" type="email"
                            class="mt-1 block w-full" :value="old('email', $employee->email)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="cargo" name="cargo" type="text"
                            class="mt-1 block w-full" :value="old('cargo', $employee->cargo)" />
                    ...
                    <div>
                        ...
                        <select id="departamento_id" name="departamento_id"
                            ...
                            @foreach($departments as $dep)
                                <option value="{{ $dep->id }}" {{ old('departamento_id', $employee->departamento_id) == $dep->id ? 'selected' : '' }}>
                                    {{ $dep->nome }}
                                </option>
                            @endforeach
                        </select>
