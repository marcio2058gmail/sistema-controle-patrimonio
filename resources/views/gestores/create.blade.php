<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Novo Gestor</h2>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                <form action="{{ route('gestores.store') }}" method="POST" class="space-y-5">
                    @csrf

                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        O gestor terá acesso ao sistema e será responsável pelo departamento selecionado.
                    </p>
                    ...
                    <div>
                        ...
                        <x-text-input id="cargo" name="cargo" type="text"
                            class="mt-1 block w-full" :value="old('cargo', 'Gestor')" placeholder="Gestor" />
