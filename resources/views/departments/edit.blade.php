<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Editar Departamento — {{ $department->nome }}
        </h2>
    </x-slot>
                ...
                <form action="{{ route('departments.update', $department) }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <x-text-input id="nome" name="nome" type="text"
                            class="mt-1 block w-full" :value="old('nome', $department->nome)" required />
                    ...
                    <div>
                        ...
                        <textarea id="descricao" name="descricao" rows="3"
                            class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-300">{{ old('descricao', $department->descricao) }}</textarea>
