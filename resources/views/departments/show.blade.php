        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-2">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex flex-col gap-1">
                    ...
                    <span class="text-3xl font-bold text-indigo-600">{{ $totalAssetsInUse }}</span>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                ...
                <dl class="space-y-2 text-sm">
                    <div class="flex gap-2">
                        ...
                        <dd class="font-medium text-gray-800 dark:text-gray-200">{{ $department->nome }}</dd>
                    </div>
                    @if($department->descricao)
                    <div class="flex gap-2">
                        <dt class="text-gray-500 w-24 shrink-0">Descrição</dt>
                        <dd class="text-gray-700 dark:text-gray-300">{{ $department->descricao }}</dd>
                    </div>
                    @endif
                    <div class="flex gap-2">
                        <dt class="text-gray-500 w-24 shrink-0">Criado em</dt>
                        <dd class="text-gray-700 dark:text-gray-300">{{ $department->created_at->format('d/m/Y') }}</dd>
                    </div>
                </dl>
            </div>
            ...
            <a href="{{ route('departments.index') }}" class="text-sm text-gray-500 hover:underline">← Voltar para lista</a>
        </div>
    </div>
</x-app-layout>
